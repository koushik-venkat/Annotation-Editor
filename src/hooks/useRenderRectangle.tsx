...
const useRenderRectangle = () => {
  const dispatch = useDispatch();
  const handleRenderingRectangle = (
    ...
    canvas.on('mouse:up', function () {
      ...
      isDown = false;
      if (rect) {
        dispatch(addAnnotations(rect.toJSON([])));
      }
    });
  };
  return { handleRenderingRectangle };
};



export default useRenderRectangle;
